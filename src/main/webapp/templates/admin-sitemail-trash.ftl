    ...
    <div class="mail-box">
        <aside class="mail-nav mail-nav-bg-color">
            ...
            <div class="mail-nav-body">
                ...
                <ul class="nav nav-pills nav-stacked mail-navigation">
                    ...
                    <li class="active"><a href="${basePath}/admin/sitemail/trash"> <i class="fa fa-trash-o"></i> 回收站</a></li>
                </ul>
            </div>
        ...
        <section class="mail-box-info">
            <header class="header">
                ...
                <div class="btn-toolbar">
                    <div class="btn-group">
                        ...
                        <button type="button" class="btn btn-primary btn-sm"><i class="fa fa-reply"></i>
                        </button>
                        <button type="button" class="btn btn-primary btn-sm"><i class="fa fa-share"></i>
                        </button>
                        <button type="button" class="btn btn-primary btn-sm"><i class="fa fa-arrow-up"></i>
                        </button>
                    </div>
                    ...
                    <div class="btn-group select">
                        <button data-toggle="dropdown" class="btn btn-primary btn-sm dropdown-toggle">
                            <span style="width: 70px;" class="dropdown-label">过滤</span>
            ...
            <section class="mail-list">
                <div class="adv-table">
                    <table id="sitemail_trash_table" class="table table-striped">
                        <thead>
                        <tr>
                        ...
                        <tbody>
                            <#list 1..14 as mail>
                                <tr>
                                    ...
                                    <td><a href="${basePath}/admin/sitemail/readmail" class="col-sm-10"><span style="color: red">[已删除]</span> Old Hu please
                                        eat rice</a><a href="#"
                                                       class="col-sm-2"><i
...
<script>
    ...
    function initInboxTable() {
        ...
        var inboxTable = $('#sitemail_trash_table').DataTable({
            'paging': true,
            'lengthChange': true,
            'searching': true,
            'ordering': true,
